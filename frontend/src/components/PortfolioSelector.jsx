      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Link to="/professional" className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2">
          ...
          <Link to="/video-editing" className="group">
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full border border-gray-100 hover:border-purple-200 transform hover:-translate-y-2">
              <div className="flex flex-col items-center text-center">
